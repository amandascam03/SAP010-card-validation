...
botao.addEventListener("click", function(e) {
    ...
    let valor = document.getElementById("numero").value; // variavel para pegar o numero inserido no input
...
//const resultado = validator.isValid("1233456");
//const resultado = validator.isValid(valor);
//console.log(resultado);
